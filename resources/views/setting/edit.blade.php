                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="border rounded-3 p-3 text-center bg-light position-relative">
                                        <img src="{{ asset($setting->image) }}" alt="Old Image"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="description" name="description" placeholder="Enter Details" required>{!! $setting->description !!}</textarea>
                                </div>
                            </div>
