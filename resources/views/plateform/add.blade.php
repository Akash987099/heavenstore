        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-4 pt-4 pb-2">
                    <form action="{{route('plateform.save')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="slug" placeholder="Enter Details" required>
                                </div>
                            </div>
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="website" name="website" placeholder="Enter Details" required>
                                </div>
                            </div>
