                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="zipcode" name="zipcode" placeholder="Enter Details" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city" placeholder="Enter Details" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address" placeholder="Enter Details" required>
                                </div>
                            </div>
