            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center category-card-header">
                    <div class="category-card-header-top">
                        <h6 class="m-0">Card Types</h6>

                        <div class="d-flex gap-2 flex-wrap">
                            <a href="{{ route('card_type.add') }}" class="btn btn-primary btn-sm category-card-add-btn">
                                + Add
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                            ...
                            <tbody id="sortable-category">
                                @foreach ($cardTypes as $key => $item)
                                    <tr data-id="{{ $item->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('card_type.edit', $item->id) }}"
                        ...
                        <div class="mt-4">
                            {{ $cardTypes->links('shared.pagination') }}
                        </div>
