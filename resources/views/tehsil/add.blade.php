        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-4 pt-4 pb-2">
                    <form action="{{route('tehsil.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" id="district" name="district" placeholder="Enter Details" required>
