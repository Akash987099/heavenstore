            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('users.index') }}">
                        ...
                        <span class="nav-link-text ms-1">WholeSale User</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('recommended.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Recommended Product</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('tehsil.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Tehsil</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('village.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Villages</span>
                    </a>
                </li>
